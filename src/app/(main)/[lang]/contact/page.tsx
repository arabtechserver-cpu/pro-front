  ...
  return (
    <div className="flex flex-col gap-12 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {/* Support Channel 1 */}
        <a href="https://wa.me/16728972935" target="_blank" rel="noopener noreferrer" className="glass-card rounded-2xl p-5 text-center flex flex-col items-center gap-3 hover:-translate-y-1.5 hover:border-violet-500/50 transition-all duration-300 shadow-md group">
          <div className="w-12 h-12 rounded-2xl bg-violet-500/10 flex items-center justify-center border border-violet-500/30 text-violet-400 group-hover:bg-violet-500 group-hover:text-white transition-all">
          ...
          <div>
            ...
            <p className="text-xs text-violet-400 font-mono mt-1 font-bold" dir="ltr">+1 (672) 897-2935</p>
          </div>
          <div className="mt-auto pt-2">
            <span className="text-[11px] text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded-full">{params.lang === "ar" ? "استجابة سريعة" : "Fast Support"}</span>
          </div>
        </a>
        
        {/* Support Channel 2 */}
        <a href="https://wa.me/249123667227" target="_blank" rel="noopener noreferrer" className="glass-card rounded-2xl p-5 text-center flex flex-col items-center gap-3 hover:-translate-y-1.5 hover:border-violet-500/50 transition-all duration-300 shadow-md group">
          <div className="w-12 h-12 rounded-2xl bg-violet-500/10 flex items-center justify-center border border-violet-500/30 text-violet-400 group-hover:bg-violet-500 group-hover:text-white transition-all">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984 0 1.762.459 3.48 1.332 5.001L2 22l5.148-1.348c1.472.802 3.13 1.224 4.863 1.225h.005c5.505 0 9.989-4.478 9.99-9.985 0-2.668-1.039-5.176-2.927-7.062A9.923 9.923 0 0 0 12.012 2zm.005 16.521h-.004c-1.493 0-2.957-.401-4.232-1.157l-.304-.18-3.146.825.839-3.067-.198-.315c-.832-1.323-1.272-2.859-1.272-4.436 0-4.492 3.656-8.147 8.152-8.147 2.176 0 4.221.848 5.76 2.387a8.096 8.096 0 0 1 2.384 5.763c0 4.493-3.656 8.147-8.152 8.147zm4.469-6.108c-.245-.123-1.452-.716-1.677-.798-.225-.082-.389-.123-.553.123-.164.246-.635.798-.778.962-.143.164-.286.184-.531.062-.245-.123-1.037-.382-1.976-1.219-.73-.651-1.223-1.455-1.366-1.7-.143-.246-.015-.379.108-.501.111-.11.245-.286.368-.429.123-.143.164-.246.245-.409.082-.164.041-.307-.02-.429-.062-.123-.553-1.332-.757-1.822-.204-.49-.409-.419-.553-.429h-.471c-.164 0-.429.062-.654.307-.225.246-.86.84-.86 2.05 0 1.209.88 2.373 1.002 2.537.123.164 1.733 2.646 4.198 3.712.586.254 1.044.406 1.401.52.59.187 1.127.16 1.551.097.473-.07 1.452-.593 1.656-1.166.204-.573.204-1.064.143-1.166-.061-.102-.225-.164-.47-.287z"/></svg>
          </div>
          <div>
            <h3 className="font-bold text-on-surface text-base">{params.lang === "ar" ? "واتساب الإدارة 2" : "WhatsApp Admin 2"}</h3>
            <p className="text-xs text-violet-400 font-mono mt-1 font-bold" dir="ltr">+249 12 366 7227</p>
          </div>
          <div className="mt-auto pt-2">
            <span className="text-[11px] text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded-full">{params.lang === "ar" ? "متاح دائماً" : "Always Available"}</span>
          </div>
        </a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
        ...
        <div className="glass-card rounded-2xl p-8 border border-outline-variant/30">
          ...
          <form className="flex flex-col gap-5">
            ...
            <button type="button" className="w-full mt-2 bg-primary-container text-on-primary-container py-3.5 rounded-lg font-bold uppercase tracking-wider hover:bg-primary transition-all glow-primary shadow-[0_0_15px_rgba(124,58,237,0.2)] active:scale-[0.98]">
              {dict.contact.send}
            </button>
          </form>
        </div>
