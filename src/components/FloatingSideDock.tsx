  ...
  return (
    <>
      <aside 
        ...
        className="flex fixed left-0 top-1/2 -translate-y-1/2 z-40 flex-col items-start gap-1.5 sm:gap-2 pointer-events-auto select-none"
      >
        <a
          ...
          className="group flex items-center bg-[#25D366] hover:bg-[#20bd5a] text-white p-2 sm:p-2.5 rounded-r-xl sm:rounded-r-2xl shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:translate-x-1 sm:hover:translate-x-1.5"
        >
        ...
        <a
          ...
          className="group flex items-center bg-[#0088cc] hover:bg-[#007ab8] text-white p-2 sm:p-2.5 rounded-r-xl sm:rounded-r-2xl shadow-lg shadow-[#0088cc]/30 transition-all duration-300 hover:translate-x-1 sm:hover:translate-x-1.5"
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="group flex items-center bg-[#1877F2] hover:bg-[#166fe5] text-white p-2 sm:p-2.5 rounded-r-xl sm:rounded-r-2xl shadow-lg shadow-[#1877F2]/30 transition-all duration-300 hover:translate-x-1 sm:hover:translate-x-1.5"
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current" viewBox="0 0 24 24">
        ...
        <button
          ...
          title={isAr ? "المساعد الذكي 24/7" : "AI Support Desk"}
          aria-label={isAr ? "المساعد الذكي 24/7" : "AI Support Desk"}
          className="group flex items-center bg-white dark:bg-[#091122]/95 hover:bg-slate-50 dark:hover:bg-[#0e1c36] text-sky-600 dark:text-sky-400 border border-slate-200 dark:border-sky-400/40 p-2 sm:p-2.5 rounded-r-xl sm:rounded-r-2xl shadow-lg shadow-slate-900/10 dark:shadow-sky-950/40 transition-all duration-300 hover:translate-x-1 sm:hover:translate-x-1.5"
        >
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-5 right-4 sm:bottom-8 sm:right-8 z-40 w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#1877F2] hover:bg-[#166fe5] text-white flex items-center justify-center shadow-lg shadow-blue-600/30 transition-all duration-300 hover:scale-105 active:scale-95 animate-in fade-in"
        >
