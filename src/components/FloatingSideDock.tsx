  ...
  return (
    <>
      <aside 
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-start gap-2 pointer-events-auto select-none"
      >
        <a
          ...
          className="group flex items-center bg-[#25D366] hover:bg-[#20bd5a] text-white p-2.5 sm:p-3 rounded-r-2xl shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:translate-x-1.5"
        >
        ...
        <a
          ...
          className="group flex items-center bg-[#0088cc] hover:bg-[#007ab8] text-white p-2.5 sm:p-3 rounded-r-2xl shadow-lg shadow-[#0088cc]/30 transition-all duration-300 hover:translate-x-1.5"
        >
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="group flex items-center bg-[#1877F2] hover:bg-[#166fe5] text-white p-2.5 sm:p-3 rounded-r-2xl shadow-lg shadow-[#1877F2]/30 transition-all duration-300 hover:translate-x-1.5"
        >
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="group flex items-center bg-[#091122]/90 hover:bg-[#0e1c36] text-sky-400 border border-sky-400/40 p-2.5 sm:p-3 rounded-r-2xl shadow-lg shadow-sky-950/40 transition-all duration-300 hover:translate-x-1.5"
        >
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-5 left-4 sm:bottom-8 sm:left-8 z-40 w-11 h-11 rounded-xl bg-[#091120]/90 hover:bg-[#0e1c36] border border-sky-400/40 text-sky-400 hover:text-white flex items-center justify-center shadow-xl shadow-black/60 transition-all duration-300 hover:scale-105 active:scale-95 animate-in fade-in"
        >
