...
export default function AmrrCountersSection({ lang }: AmrrCountersSectionProps) {
  ...
  return (
    <section className="relative w-full my-6 sm:my-10 overflow-visible">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_50%_50%,rgba(109,40,217,0.18),transparent)] pointer-events-none"></div>
      <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-violet-700/15 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute -right-20 top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-purple-600/12 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="relative group">
          ...
          <div className="flex items-center gap-2 bg-gradient-to-r from-slate-900/95 via-cyan-950/90 to-slate-900/95 backdrop-blur-xl border-2 border-cyan-400/60 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full shadow-[0_10px_30px_rgba(34,211,238,0.5)]">
            <span className="relative flex h-2 sm:h-2.5 w-2 sm:w-2.5">
              ...
              <span className="relative inline-flex rounded-full h-2 sm:h-2.5 w-2 sm:w-2.5 bg-violet-400"></span>
            </span>
            <span className="text-[10px] sm:text-xs font-black text-cyan-300 tracking-wider flex items-center gap-1 whitespace-nowrap">
              <i className="fas fa-microchip text-violet-400 animate-spin-slow"></i>
              <span>{isAr ? "معالجة سحابية فائقة" : "Cloud Engine"}</span>
              <span className="text-violet-400 font-mono text-[9px] sm:text-[10px]">v4.2</span>
            </span>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute -top-[2px] left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-cyan-400 to-transparent shadow-[0_0_20px_#8b5cf6] pointer-events-none"></div>
        <div className="absolute -top-[1px] left-1/4 right-1/4 h-[2px] bg-gradient-to-r from-violet-500/80 via-fuchsia-400 to-cyan-400/80 blur-[1px] pointer-events-none"></div>

        {/* Ambient Radial Bulge / Curvature Lighting (يعطي إحساس التقوس ثلاثي الأبعاد) */}
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[90%] sm:w-[600px] h-64 bg-gradient-to-b from-cyan-500/20 via-violet-500/10 to-transparent rounded-[100%] blur-[70px] pointer-events-none"></div>
        ...
        <div className="absolute inset-0 overflow-hidden rounded-2xl sm:rounded-[2.75rem] pointer-events-none">
          <div className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-violet-400 to-transparent shadow-[0_0_15px_#a78bfa] animate-laser-scan"></div>
          {/* Subtle curved grid lines */}
          <div className="absolute inset-0 bg-[radial-gradient(#a78bfa_1px,transparent_1px)] [background-size:24px_24px] opacity-10"></div>
        </div>
        ...
        <div className="relative z-10 grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-start" data-aos="fade-right" suppressHydrationWarning>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 mb-4 sm:mb-5">
              ...
              <div className="inline-flex items-center gap-2 bg-[#080b1c]/90 border border-violet-500/40 px-3.5 py-1.5 rounded-full shadow-[0_4px_15px_rgba(139,92,246,0.25)]">
                <span className="w-2.5 h-2.5 rounded-full bg-violet-400 online-blink shadow-[0_0_8px_#a78bfa]"></span>
                <span className="text-violet-300 font-black text-xs tracking-wider">ONLINE</span>
                {/* Live soundwave animation */}
                <div className="flex items-center gap-0.5 h-4 px-1 border-s border-slate-700 ms-1">
                  <span className="w-0.5 bg-violet-400 rounded-full animate-soundwave-1"></span>
                  <span className="w-0.5 bg-cyan-400 rounded-full animate-soundwave-2"></span>
                  <span className="w-0.5 bg-violet-400 rounded-full animate-soundwave-3"></span>
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black mb-3 sm:mb-4 leading-tight tracking-tight">
              ...
              <span className="relative inline-block mt-1 sm:mt-0 mx-1">
                ...
                <span className="relative z-10 bg-gradient-to-r from-violet-400 via-purple-400 to-cyan-400 text-slate-950 font-black px-4 py-1 rounded-xl shadow-[0_8px_20px_rgba(139,92,246,0.4),inset_0_2px_2px_rgba(255,255,255,0.6)] inline-block transform -rotate-1 hover:rotate-0 transition-transform">
                  {isAr ? "عرب تك برو" : "Arab Tech Pro"}
                </span>
              </span>
              <br />
              <span className="bg-gradient-to-r from-cyan-400 via-violet-300 to-purple-200 bg-clip-text text-transparent block mt-2 text-xl sm:text-3xl lg:text-4xl font-extrabold drop-shadow-[0_2px_15px_rgba(34,211,238,0.35)]">
            ...
            <p className="text-xs sm:text-base lg:text-lg text-slate-300 mb-6 max-w-xl leading-relaxed">
              {isAr ? (
                <>
                  منصة <strong className="text-white font-bold">عرب تك برو سيرفر (عرب تك)</strong>: المنظومة السحابية الموحدة لفك شفرات الشبكات (IMEI)، وتخطي FRP، وحذف حسابات iCloud، وشحن رصيد كافة السيرفرات والبوكسات فورياً وبأفضل أسعار الجملة.
                </>
              ) : (
                <>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 sm:gap-3 mb-6 sm:mb-8">
              <div className="convex-pill bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border border-violet-500/40 text-slate-200 text-xs sm:text-sm font-bold px-4 py-2 flex items-center gap-2 shadow-[0_6px_20px_rgba(139,92,246,0.25)] hover:border-violet-400 cursor-default">
                <div className="w-5 h-5 rounded-full bg-violet-500/20 flex items-center justify-center text-violet-400 text-xs">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
              {/* Primary Purple Glow Pill Button */}
              <Link
                href={isLoggedIn ? `/${lang}/pricing` : `/${lang}/register`}
                className="btn-purple-glow px-7 sm:px-9 py-3.5 sm:py-4 font-black text-sm sm:text-base flex items-center justify-center gap-3 group"
              >
              ...
              >
                <i className="fas fa-list-alt text-cyan-400 group-hover:scale-110 transition-transform"></i>
          ...
          <div className="lg:col-span-5 flex flex-col gap-3.5 sm:gap-4.5 w-full">
            ...
            <div
              className="convex-card group relative p-4 sm:p-5 flex items-center gap-4 sm:gap-5 cursor-pointer will-change-transform active:scale-[0.97] active:border-violet-400 active:shadow-[0_0_30px_rgba(139,92,246,0.5)] transition-all duration-200"
              data-aos="fade-left"
              data-aos-delay="100"
            >
              ...
              <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-violet-400/25 via-slate-800 to-violet-600/15 border-2 border-violet-400/40 text-violet-300 flex items-center justify-center text-2xl sm:text-3xl shrink-0 shadow-[0_8px_20px_rgba(139,92,246,0.35),inset_0_2px_3px_rgba(255,255,255,0.4)] group-hover:scale-110 group-hover:rotate-3 transition-transform">
                <i className="fas fa-mobile-alt animate-float"></i>
                {/* Mini Pulse Badge */}
                <span className="absolute -top-1 -right-1 w-3 h-3 bg-violet-400 rounded-full border border-slate-900 shadow animate-ping"></span>
              </div>

              {/* Number & Label */}
              <div className="flex-1 min-w-0">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-300 to-purple-200 tracking-tight drop-shadow-[0_0_15px_rgba(139,92,246,0.5)]">
                    +{counts.devices}
                  </span>
                  <span className="text-violet-400 text-xs font-bold uppercase tracking-wider">Models</span>
                </div>
                <p className="text-slate-200 text-xs sm:text-sm font-bold truncate">
                  {isAr ? "موديل وطراز هاتف مدعوم" : "Supported device models"}
                </p>
                <span className="text-[10px] text-violet-400/90 font-medium">
                  {isAr ? "Samsung, Apple, Xiaomi, Huawei & More" : "All global brands & chipsets"}
                </span>
              </div>

              {/* Floating Arrow */}
              <i className="fas fa-chevron-left rtl:rotate-0 ltr:rotate-180 text-xs text-slate-500 group-hover:text-violet-400 group-hover:translate-x-[-4px] transition-all"></i>
            </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-purple-200 tracking-tight drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">
                    +{counts.services}
                  </span>
        ...
        <div className="absolute -bottom-[2px] left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-violet-400/80 to-transparent shadow-[0_0_15px_#a78bfa] pointer-events-none"></div>
