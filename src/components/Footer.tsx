...
export default function Footer({ dict, lang = "ar" }: FooterProps) {
  const paymentMethods = [
    ...
    },
    {
      id: "fawry",
      nameAr: "فوري (Fawri)",
      nameEn: "Fawri Banking",
      badge: "FAWRI",
      tagAr: "ID: 51589889",
      tagEn: "ID: 51589889",
      color: "from-purple-600/15 to-indigo-600/15 border-purple-400/40 text-purple-300"
    },
    {
      id: "binance",
  ...
  return (
    <footer className="mt-auto bg-gradient-to-b from-transparent via-[#090e18]/45 to-[#060a12]/75 backdrop-blur-md border-t border-white/10 relative overflow-hidden">
      <div className="w-full cyber-container py-12 relative z-10 space-y-10">
        ...
        <div className="pt-6 border-t border-outline-variant/20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
          {/* Site Name & Identity */}
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] backdrop-blur-sm hover:bg-emerald-500/10 border border-white/10 hover:border-emerald-500/40 transition-all duration-200 group"
          >
          ...
          <a
            href="mailto:arabtechserver@gmail.com"
            className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] backdrop-blur-sm hover:bg-rose-500/10 border border-white/10 hover:border-rose-500/40 transition-all duration-200 group"
          >
