...
export default function CyberMouseBackground() {
  ...
  return (
    <>
      ...
      {/* 2. Full-Page Vertical Cyber Light Beams (Desktop only to prevent mobile scroll lag) */}
      <div className="hidden md:block fixed inset-0 pointer-events-none z-0 overflow-hidden opacity-40">
